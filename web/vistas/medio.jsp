...
<a href="ControllerMedio?accion=add"" role="button" class="btn btn-success">Nuevo</a>
    <table class="table table-responsive">
        <tr>
            <th>Numero de Medio</th>
            <th>Proyecto</th>
            <th>URL</th>
            ...
            List<medio> list=dao.listar();

            Iterator<medio>iter=list.iterator();
            medio u = null;
            while(iter.hasNext()){
                u=iter.next();
            %>            <tbody>
            ...
            <a href="ControllerMedio?accion=editar&id=<%= u.getIdmedio()%>" role="button" class="btn btn-primary text-white">Editar</a>
            </td>
            <td>
                <a href="ControllerMedio?accion=eliminar&id=<%= u.getIdmedio()%>" onclick="javascript:return confirm('¿Esta seguro que desea eliminar el registro?');" role="button" class="btn btn-danger text-white">Eliminar</a>
            </td>
                </tr>
                <%
                    }
