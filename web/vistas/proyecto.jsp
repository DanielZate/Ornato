...
<html>
    ...
    <table class="table table-responsive">
        <tr>
            ...
            <td>
                <a href="ControllerProyecto?accion=eliminar&id=<%=u.getIdProyecto()%>" onclick="javascript:return confirm('¿Esta seguro que desea eliminar el registro?');" role="button" class="btn btn-danger text-white">Eliminar</a>
            </td>
            <td>                
