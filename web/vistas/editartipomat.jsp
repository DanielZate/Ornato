...
<html>
    ...
    <body class="left-side-menu-dark">
        ...
        int id =Integer.parseInt((String)request.getAttribute("idtipomat"));
        tipomaterial tp =(tipomaterial)dao.list(id);
        %>
...
.divA label{
  ...
  <center><h1>Editar Tipo Material</h1></center><!-- comment -->
         <a href="Controllertipomat?accion=listar" class="btn btn-secondary">Volver</a>

   <br><br>
        <div class="divcontenedor">
            <div class="divA">
          <form action="Controllertipomat">
              
                 <input type="hidden" name="idtipomat"value="<%=tp.getIdtipomaterial()%>">
      
     <div class="form-row">
    <div class="form-group col-md-6">             
        <label>Tipo Material</label>
                     
        <input type="text" name="tipomat" value="<%=tp.getTipomaterial()%>" class="form-control">
         </div>  
