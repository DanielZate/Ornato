...
<html>
    ...
    <body class="left-side-menu-dark">
        ...
        tipoproducto tp =(tipoproducto)dao.list(id);
...
.divA label{
  ...
  </style>                   <center><h1>Editar Tipo Producto</h1></center>
    <a href="Controllertipopro?accion=listar" class="btn btn-secondary">Volver</a>
  <br><br>
        <div class="divcontenedor">
            <div class="divA">
          <form action="Controllertipopro">
              
           <input type="hidden" name="idtipopro" value="<%=tp.getIdtipoproducto()%>">   
    ...
    <div class="form-group col-md-6">  
            ...
            <input type="text" name="tipopro" value="<%=tp.getTipoproducto()%>" class="form-control">
             </div>  
