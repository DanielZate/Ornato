...
<head>
  ...
  <center><h1>Rol</h1></center>  
    <table class="table table-bordered table-hover text-center">
<a href="Controller?accion=add"" role="button" class="btn btn-success">Nuevo Rol</a>
            ...
            <tbody>
                <tr>
                    <td><%=rl.getIdrol()%></td>
                     <td><%=rl.getRol()%></td>
                     <td>
                         <a href="Controller?accion=editar&id=<%=rl.getIdrol()%>" role="button" class="btn btn-primary text-white">Editar</a>
                         <a href="Controller?accion=eliminar&id=<%=rl.getIdrol()%>" javascript:return confirm('¿Esta seguro que desea eliminar el registro?');" role="button" class="btn btn-danger text-white">Eliminar</a>
                     </td>
                </tr>
                <%}%>
            </tbody>
