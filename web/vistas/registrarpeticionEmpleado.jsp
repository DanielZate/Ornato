   ...
   <html>
    ...
    <body class="left-side-menu-dark">
       ...
       <div class="d-flex">
            <div class="col-sm-4">
                <div class="card">
                    <form action="ControllerPeticionEmpleado?menu=peticion" method="POST">
                    <div class="card-body">
            ...
            <div class="col-sm-8">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <a onclick="javascript:return alert('su peticion ha sido enviada');"href="ControllerPeticionEmpleado?menu=peticion&accion=GenerarPeticion" class="btn btn-success">Generar Peticion</a>
                    </div>
