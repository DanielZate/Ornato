...
<html>
  ...
  <center><h1>Tipo Productos</h1></center>  
    <table class="table table-bordered table-hover text-center">
<a href="Controllertipopro?accion=add"" role="button" class="btn btn-success">Nuevo</a>
    <table class="table table-responsive">
        <tr>
              ...
              <%
                  ...
                  List<tipoproducto>list=dao.listar();
                  Iterator<tipoproducto>iter=list.iterator();
        ...
        <tbody>
                <tr>
                    <td><%=tp.getIdtipoproducto()%></td>
                     <td><%=tp.getTipoproducto()%></td>
            <td>
                
            <a  href="Controllertipopro?accion=editar&id=<%=tp.getIdtipoproducto()%>" role="button" class="btn btn-primary text-white">Editar</a>
            </td>
            <td>
                <a href="Controllertipopro?accion=eliminar&id=<%=tp.getIdtipoproducto()%>" onclick="javascript:return confirm('¿Esta seguro que desea eliminar el registro?');" role="button" class="btn btn-danger text-white">Eliminar</a>
            </td>
                </tr>
                <%}%>
