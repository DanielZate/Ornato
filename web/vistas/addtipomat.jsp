...
.divA label{
  ...
  <center><h1>Nuevo Tipo Material</h1></center>  
       <a href="Controllertipomat?accion=listar" class="btn btn-secondary">Volver</a>
        <br><br>
        <div class="divcontenedor">
            <div class="divA">
                <form action="Controllertipomat"  id="formulario">
            
    <div class="form-row">
    <div class="form-group col-md-6" id="g-Material">
        <label form="tipomat">Tipo Material</label> 
         <div class="frm-group-input">
       
            <input type="text" name="tipomat" class="form-control" id="tipomat">        
       ...
       <!-- Vendor js -->
       <script src="./js/validacionTipoMat.js"></script>
