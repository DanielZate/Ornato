        ...
        <tr>
          ...
          <%
           ...
           <td><%= u.getPrecioDetalle()%></td>
            ...
            <a href="ControllerDetalle?accion=editar&id=<%=u.getIdDetalle()%>" role="button" class="btn btn-primary text-white">Editar</a>
            </td>
            <td>
                <a href="ControllerDetalle?accion=eliminar&id=<%=u.getIdDetalle()%>" onclick="javascript:return confirm('¿Esta seguro que desea eliminar el registro?');" role="button" class="btn btn-danger text-white">Eliminar</a>
            </td>
                </tr>            
                <%
                    }
