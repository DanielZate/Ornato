...
<%@page import="Model.tipomaterial"%>
...
<html>
  ...
  <center><h1>Tipo Material</h1></center>  
    <table class="table table-bordered table-hover text-center">
<a href="Controllertipomat?accion=add"" role="button" class="btn btn-success">Nuevo</a>
    <table class="table table-responsive">
        <tr>
            ...
            List<tipomaterial>list=dao.listar();
            Iterator<tipomaterial>iter=list.iterator();
            tipomaterial tp=null;
            while(iter.hasNext()){
            tp=iter.next();
            ...
            <tbody>
                <tr>
                    <td><%=tp.getIdtipomaterial()%></td>
                    <td><%=tp.getTipomaterial()%></td>
                    <td>
            <a href="Controllertipomat?accion=editar&id=<%=tp.getIdtipomaterial()%>" role="button" class="btn btn-primary text-white">Editar</a>
            </td>
            <td>
                <a href="Controllertipomat?accion=eliminar&id=<%=tp.getIdtipomaterial()%>" onclick="javascript:return confirm('¿Esta seguro que desea eliminar el registro?');" role="button" class="btn btn-danger text-white">Eliminar</a>
            </td>
                </tr>
                <%}%>
