...
<html lang="en">
    ...
    <body class="left-side-menu-dark">
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                  ...
                  <center><h1>Proyectos En Cotizacion</h1></center>  
                  <br>
        <a href="ControllerProyecto?accion=CotizacionEmpleado" role="button" class="btn btn-secondary mr-2">Cotizacion</a>

        <a href="ControllerProyecto?accion=EjecucionEmpleado" role="button" class="btn btn-secondary mr-2" >Ejecucion</a>
        <br><br>
 ...
 <th>#</th>
            ...
            List<proyecto> list=dao.listarCotizacion();
            ...
            %>            <tbody>
                <tr>
                    ...
                    <td><%= u.getEstadoProyecto() %>
                    </td>    
                    <td> 
            <a href="ControllerDetalle?accion=verDetallesE&id=<%=u.getIdProyecto()%>" role="button" class="btn btn-info text-white">Ver Detalles</a>
            </td>
