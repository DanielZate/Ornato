...
<html>
  ...
  <form action="ControllerMedio" method="POST" enctype="multipart/form-data"> 

          
       <%
            medioDAO dao=new medioDAO();
            int id=Integer.parseInt((String)request.getAttribute("idPro"));
            medio p=(medio)dao.listarRegistrar(id);
            
            medio e=(medio)dao.list(id);
...
.divA label{
    ...
    <br><br>
      ...
      <input type="hidden" name="idtext" value="<%=e.getIdmedio()%>">
  
 
        <div id="form-group-input">
            <input type="hidden" name="proyecto" value="<%=p.getIdProyecto()%>"  class="form-control">
        </div>
...
<div class="form-row">
       <div class="form-group col-md-6">
        <label form="nomusuario">URL</label>
        <div id="form-group-input">
            <input type="text" name="url" value="<%= e.getUrl()%> "  class="form-control">
        </div>
    </div>
        ...
        <div id="form-group-input">
            <input type="file" name="foto" value="<%= e.getFoto() %>" class="form-control">
        </div>
    </div>
</div>
        <br>
