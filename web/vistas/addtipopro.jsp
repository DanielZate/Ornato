...
.divA label{
  ...
  <center><h1>Nuevo Tipo Producto</h1></center> 
           <a href="Controllertipopro?accion=listar" class="btn btn-secondary">Volver</a>

   <br><br>
        <div class="divcontenedor">
            <div class="divA">
                                <form action="Controllertipopro"  id="formulario">
                        
    <div class="form-row">
        <div class="form-group col-md-6" id="g-Producto">
         <label form="tipopro">Tipo Producto</label>
        <div id="form-group-input">
            <input type="text" name="tipopro" class="form-control" id="tipopro">       
       ...
       <!-- Vendor js -->
       <script src="./js/validarTipoPro.js"></script>
