                        ...
                        <ul class="metismenu" id="menu-bar">
                            ...
                            <li>
                                <a href="javascript: void(0);">
                                    ...
                                    <span> Proyectos </span>
<img src="./images/DobleFelcha.png" height="30px"  margin-left="100px" >                                </a>
  ...
  <center><h1>Proyectos Finalizados</h1></center>  
  <br>
    ...
    <table class="table table-responsive">
        <tr>
            ...
            List<proyecto> list=dao.listarFinalizados();
           ...
           <tbody>
            ...
            <a href="ControllerProyecto?accion=editar&id=<%=u.getIdProyecto()%>" role="button" class="btn btn-primary text-white">Editar</a>
            </td>
            <td>
                <a  onclick="javascript:return confirm('¿Esta seguro que desea eliminar el registro?');" role="button" class="btn btn-danger text-white">Eliminar</a>
                        ...
                        <td>                
            <a href="ControllerDetalle?accion=verDetalles&id=<%=u.getIdProyecto()%>" role="button" class="btn btn-info text-white">Detalles</a>
            </td>
                                    <td>                
            <a href="ControllerMedio?accion=AgregarMedio&id=<%=u.getIdProyecto()%>" role="button" class="btn btn-success text-white">Medio</a>
            </td>
                </tr>
                       <%
                    }
