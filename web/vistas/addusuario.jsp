    ...
    <body class="left-side-menu-dark">
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <jsp:useBean id="id_rol" scope="session" class="ModeloDao.rolDAO"/>
                 <%
...
.divA label{
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6 formulario__grupo " id="g-apellido">
  ...
  <br>
    ...
    <div class="form-group col-md-6 " id="g-numdoc">
      ...
      <div class="frm-group-input">
      <input type="numdoc" class="form-control" name="numdoc" id="numdoc">
        <i class="form-icono fas fa-exclamation-circle"></i>
        <span class="msn-error">Solo puede ingresar numeros, max 10 digitos</span>
    </div></div>
      
      
      <div class="form-group col-md-6 formulario__grupo" id="g-correo">
    ...
    <div class="form-group col-md-6 formulario__grupo" id="g-telefono">
      ...
      <label form="rol">Rol </label>
       ...
       <!-- Vendor js -->
        <script src="./js/ususariovalidacion.js"></script>
