    ...
    <body class="left-side-menu-dark">
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                   ...
                   <jsp:useBean id="id_tipo_producto" scope="session" class="ModeloDao.tipomaterialDAO"/>
                 <%
         ...
         <%
            ...
            material m=(material)dao2.list(id);
        %>
                          <style type="text/css">
.divcontenedor
{
...
.divA label{
    ...
    font-size: medium  ;
          ...
          <center><h1>Nuevo Material</h1></center> 
            <a href="ControllerMaterial?accion=listar" class="btn btn-secondary">Volver</a>
          <br><br>
        <div class="divcontenedor">
            <div class="divA">
    <form action="ControllerMaterial"> 
  
            <input type="hidden" name="txtid" value="<%= m.getIdMaterial()%>" class="form-control">
    ...
    <div class="form-group col-md-6"> 
        ...
        <option value="<%= m.getIdTipoMaterial() %>" class="form-control"><%= m.getTipoNombre()%> </option>
     
       <%= dao.listarMaterialSelect()%>
     ...
     <div class="form-group col-md-6">
        ...
        <div id="form-group-input">
            <input type="text" name="Nombre" value="<%= m.getNombreMaterial() %>" class="form-control">
        </div>
    </div>
        </div>
