...
<html>
    ...
    <body class="left-side-menu-dark">
        ...
        <div id="wrapper">
            ...
            <div class="left-side-menu">
                <div class="media user-profile mt-2 mb-2">
                    ...
                    <img src="./images/icono.png" class="avatar-xs rounded-circle mr-2" alt="Shreyu" />
                ...
                <div class="sidebar-content">
                    ...
                    <div id="sidebar-menu" class="slimscroll-menu">
                        <ul class="metismenu" id="menu-bar">
                            ...
                            <li>
                                <a href="ControllerDetalle?accion=listarU" aria-expanded="false">
       ...
       <div class="d-flex">
            <div class="col-sm-4">
                <div class="card">
                    <form action="ControllerPeticion?menu=peticion" method="POST">
                    <div class="card-body">
            ...
            <div class="col-sm-8">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <a onclick="javascript:return alert('su peticion ha sido enviada');"href="ControllerPeticion?menu=peticion&accion=GenerarPeticion" class="btn btn-success">Generar Peticion</a>
                    </div>
