...
<a href="ControllerMaterial?accion=add"" role="button" class="btn btn-success">Nuevo</a>
    <table class="table table-responsive">
        <tr>
            ...
            %>            <tbody>
                <tr>
                    <td><%= u.getIdMaterial()%></td>
                   <td><%= u.getTipoNombre()%></td>
                    <td><%= u.getNombreMaterial()%></td>

                    
            <td>
                
            <a href="ControllerMaterial?accion=edit&id=<%= u.getIdMaterial()%>" role="button" class="btn btn-primary text-white">Editar</a>
            </td>
            <td>
                <a href="ControllerMaterial?accion=eliminar&id=<%= u.getIdMaterial()%>"  onclick="javascript:return confirm('¿Esta seguro que desea eliminar el registro?');" role="button" class="btn btn-danger text-white">Eliminar</a>
            </td>
                </tr>
                <%
                    }
