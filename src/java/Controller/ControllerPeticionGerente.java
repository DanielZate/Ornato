 ...
 * @author User
 */
@WebServlet(name = "ControllerPeticionGerente", urlPatterns = {"/ControllerPeticionGerente"})
public class ControllerPeticionGerente extends HttpServlet {
...
if(menu.equals("peticion")){
            ...
            default:
                ...
                request.getRequestDispatcher("vistas/registrarpeticionGerente.jsp").forward(request, response);
            }
