 ...
 * @author user
 */
@WebServlet(name = "ControllerPeticion", urlPatterns = {"/ControllerPeticion"})
public class ControllerPeticion extends HttpServlet {
...
if(menu.equals("peticion")){
            ...
            default:
                ...
                request.getRequestDispatcher("vistas/registrarpeticion.jsp").forward(request, response);
            }
